...
result.dataSources.map((obj) => {
    ...
    obj[fn.dataSources.nn] ? dataSourcesMap.set(obj[fn.dataSources.nn].toString().replace(new RegExp("\"", 'g')," "), fn.dataSources.nn) : null;
    obj[fn.dataSources.nv] ? dataSourcesMap.set(obj[fn.dataSources.nv].toString().replace(new RegExp("\"", 'g')," "), fn.dataSources.nv) : null;
