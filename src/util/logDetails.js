messageLog = {
    error: {
        ...
        ERR_ADD_DOMAIN_USER: 'Not add %s user to person with the identifier: %s to the person with the idetifier: %s from %s. The error message:"%s"',
    ...
    info: {
        ...
        INF_ADD_DOMAIN_USER: 'Add %s user %s to the person with the idetifier: %s from %s successfully.',
